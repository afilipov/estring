...
#ifdef INTERNAL
#define __ns_int_icscanf __internal_ns_int_icscanf
...
/******************************************************************************/
/* CHAR & INT SCANF WITHOUT SET MATCHING                                      */
/******************************************************************************/
...
next_hex:
	...
	uns1 = 0l;
	  ...
	  while (ch != EOF)
	    ...
	    if (ch >= '0' && ch <= '9')
	    {
	    uns1 = (uns1 * 10) + (ch - '0');	/* convert to decimal*/
	...
	uns1 = 0l;
	  do
	  {
	    ...
	    if(ch >= '0' && ch <= '7')
	    {
	    uns1 = (uns1 * 8) + (ch - '0');	/* convert to octal */
	    ++count;
	      if (count == max_field && max_field != 0)
	      {
	      break;
